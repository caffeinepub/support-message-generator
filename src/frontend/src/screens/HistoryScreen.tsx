        ...
        >
          ...
          {hasActiveFilter && (
            <button
              ...
              className="w-full h-9 rounded-xl border border-border/60 text-xs text-muted-foreground hover:text-foreground hover:border-border transition-colors"
        ...
        <div className="text-center py-16" data-ocid="history.empty_state">
          ...
          {hasActiveFilter && (
            <button
              type="button"
              onClick={clearFilters}
              className="mt-4 text-xs brand-text underline underline-offset-2"
            >
              Clear filters
            </button>
          )}
        ...
        <div className="space-y-5">
          {dateKeys.map((dateKey) => {
            ...
            const isFirstOfMonth =
              ...
              dateKeys[dateKeys.indexOf(dateKey) - 1].slice(0, 7) !== monthKey;
