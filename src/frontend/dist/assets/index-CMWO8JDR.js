...
function BottomNav({ active, onChange }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "nav",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-full", children: TABS.map(({ id, label, Icon: Icon2 }) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            type: "button",
            onClick: () => onChange(id),
            className: `flex-1 flex flex-col items-center justify-center gap-0.5 transition-colors relative ${isActive ? "brand-text" : "text-muted-foreground"}`,
            ...
            children: [
              ...
              isActive && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute bottom-0 left-1/2 -translate-x-1/2 w-6 h-0.5 brand-bg rounded-full" })
            ]
          },
          id
        );
...
function monthlySpent(expenses) {
  const prefix2 = todayStr().slice(0, 7);
  return expenses.filter((e) => e.date.startsWith(prefix2)).reduce((s, e) => s + e.amount, 0);
}
function dailySpent(expenses, date) {
  return expenses.filter((e) => e.date === date).reduce((s, e) => s + e.amount, 0);
}
function baseDailyLimit(profile) {
...
function adjustedDailyLimit(profile, expenses) {
...
function availableBalance(profile, expenses) {
  const budget = profile.monthlyIncome - profile.fixedExpenses - profile.savingsGoal;
  return Math.max(0, budget - monthlySpent(expenses));
}
function monthlyBudget(profile) {
  return Math.max(
    0,
...
function categorySpend(expenses) {
  ...
  for (const e of expenses) {
    if (!e.date.startsWith(prefix2)) continue;
    result[e.category] = (result[e.category] || 0) + e.amount;
  }
  return result;
}
function healthScore(profile, expenses) {
  ...
  const daysWithData = new Set(
    expenses.filter((e) => e.date.startsWith(prefix2)).map((e) => e.date)
  );
  let withinBudget = 0;
  for (const d of daysWithData) {
    if (dailySpent(expenses, d) <= base) withinBudget++;
  }
  const budgetDiscipline = daysWithData.size > 0 ? Math.round(withinBudget / daysWithData.size * 100) : 80;
  const dailyAmounts = Array.from(daysWithData).map(
    (d) => dailySpent(expenses, d)
  );
  let consistency = 75;
  if (dailyAmounts.length > 1) {
    const mean = dailyAmounts.reduce((a, b) => a + b, 0) / dailyAmounts.length;
    const variance = dailyAmounts.reduce((s, v2) => s + (v2 - mean) ** 2, 0) / dailyAmounts.length;
...
function savedThisMonth(profile, expenses) {
  return Math.max(
    0,
    profile.monthlyIncome - profile.fixedExpenses - monthlySpent(expenses)
  );
}
function dailySavingsNeeded(profile, expenses) {
...
function Onboarding({ onComplete }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background flex flex-col items-center justify-center px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-10 text-center animate-fade-up", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-2xl brand-bg flex items-center justify-center mx-auto mb-3 glow-brand", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Wallet, { className: "w-8 h-8 text-background" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold text-foreground", children: "AI Cash Manager" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mt-1", children: "Your smart financial companion" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-xs mb-8", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-xs glass-card p-6 animate-fade-up", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-xl bg-primary/10 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "w-5 h-5 brand-text" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-semibold text-foreground", children: current.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: current.subtitle })
        ] })
      ] }),
      isLastStep ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs text-muted-foreground uppercase tracking-wider mb-1.5 block", children: "Monthly Goal Amount (₹)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
              type: "number",
              ...
              onChange: (e) => setValues((v2) => ({ ...v2, savingsGoal: e.target.value })),
              onKeyDown: handleKey,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs text-muted-foreground uppercase tracking-wider mb-1.5 block", children: "Goal Name" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
              type: "text",
              ...
              onChange: (e) => setValues((v2) => ({ ...v2, goalName: e.target.value })),
              onKeyDown: handleKey,
              className: "bg-muted/50 border-border/60 text-foreground placeholder:text-muted-foreground/60 text-base h-12"
            }
          )
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs text-muted-foreground uppercase tracking-wider mb-1.5 block", children: "Amount (₹)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            type: "number",
            ...
            onChange: (e) => setValues((v2) => ({ ...v2, [current.field]: e.target.value })),
            onKeyDown: handleKey,
            className: "bg-muted/50 border-border/60 text-foreground placeholder:text-muted-foreground/60 text-base h-12",
            autoFocus: true,
            "data-ocid": "onboarding.input"
      ...
      isLastStep && values.monthlyIncome && values.fixedExpenses && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 p-3 rounded-xl bg-primary/10 space-y-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Your disposable budget:" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-lg font-bold brand-text", children: [
          fmtFull(
            Math.max(
              0,
              Number(values.monthlyIncome) - Number(values.fixedExpenses) - Number(values.savingsGoal)
            )
          ),
          "/mo"
        ] })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Button,
        {
          ...
          children: [
            ...
            !isLastStep && /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { className: "w-4 h-4 ml-1" })
          ]
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2 mt-6", children: STEPS.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: `h-1.5 rounded-full transition-all duration-300 ${i === step ? "w-6 brand-bg" : i < step ? "w-3 brand-bg opacity-40" : "w-3 bg-muted"}`
      },
      s.id
    )) })
  ] });
...
function getAIResponse(input, profile, expenses) {
  ...
  if (q.includes("save more") || q.includes("how to save") || q.includes("saving tips") || q.includes("savings")) {
    const catSpend = categorySpend(expenses);
    const topCat = Object.entries(catSpend).sort((a, b) => b[1] - a[1])[0];
    const topTip = topCat ? `Your highest spending category is **${topCat[0]}** (${fmt(topCat[1])}). Try reducing it by 20%.` : "Track all expenses consistently to find saving opportunities.";
...
Remaining: ${fmtFull(Math.max(0, budget - spent))}`;
  ...
  if (q.includes("expense") || q.includes("spending") || q.includes("spent")) {
    ...
    const lines = entries.map(([cat, amt]) => `• ${cat}: ${fmtFull(amt)}`).join("\n");
...
Total: ${fmtFull(monthlySpent(expenses))}`;
  ...
  if (q.includes("health") || q.includes("score") || q.includes("financial")) {
    ...
    const msg = score >= 70 ? "Great job! You're managing your finances well. Keep it up!" : score >= 40 ? "You're doing okay, but there's room to improve. Focus on staying within your daily budget." : "Let's work on improving! Try to stick to your daily limit and increase savings gradually.";
...
${msg}`;
  ...
  if (q.includes("goal") || q.includes("target")) {
    ...
    const pct = profile.savingsGoal > 0 ? Math.round(saved / profile.savingsGoal * 100) : 0;
    const goalMsg = pct >= 100 ? "🎉 Congratulations! You've reached your goal!" : pct >= 50 ? "You're halfway there! Keep going!" : "Every rupee counts. Stay consistent and you'll get there!";
...
function ChatScreen({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 pt-4 pb-3 border-b border-border/40 flex-shrink-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-xl brand-bg flex items-center justify-center glow-brand", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "w-5 h-5 text-background" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-bold text-foreground", children: "AI Assistant" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground flex items-center gap-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-1.5 h-1.5 bg-success rounded-full inline-block" }),
            "Always here to help"
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2 mt-3 overflow-x-auto scrollbar-none pb-1", children: SUGGESTIONS.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-y-auto px-4 py-3 space-y-3 scrollbar-none", children: [
      messages.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-8", "data-ocid": "chat.empty_state", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-2xl brand-bg flex items-center justify-center mx-auto mb-3 glow-brand", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Bot, { className: "w-8 h-8 text-background" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-foreground", children: "Hi! I'm your AI Cash Manager" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1", children: "Ask me anything about your finances" })
      ] }),
      messages.map((msg, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: `flex gap-2.5 ${msg.sender === "user" ? "flex-row-reverse" : ""} animate-fade-up`,
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                className: `w-7 h-7 rounded-full flex-shrink-0 flex items-center justify-center ${msg.sender === "ai" ? "brand-bg" : "bg-muted"}`,
                children: msg.sender === "ai" ? /* @__PURE__ */ jsxRuntimeExports.jsx(Bot, { className: "w-3.5 h-3.5 text-background" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(User, { className: "w-3.5 h-3.5 text-foreground" })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                className: `max-w-[80%] rounded-2xl px-4 py-3 text-sm leading-relaxed ${msg.sender === "user" ? "brand-bg text-background rounded-tr-sm" : "chat-bubble-ai text-foreground rounded-tl-sm"}`,
                children: msg.sender === "ai" ? formatText(msg.text) : msg.text
              }
            )
          ]
        },
      ...
      typing && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-7 h-7 rounded-full brand-bg flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Bot, { className: "w-3.5 h-3.5 text-background" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "chat-bubble-ai rounded-2xl rounded-tl-sm px-4 py-3",
            "data-ocid": "chat.loading_state",
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1", children: [0, 1, 2].map((dotIdx) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 pb-4 pt-2 border-t border-border/40 flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
        {
          ref: inputRef,
...
function Greeting() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground/70 mt-0.5", children: date })
  ] });
}
function Dashboard({
  profile,
  ...
  const savingsPct = profile.savingsGoal > 0 ? Math.min(100, saved / profile.savingsGoal * 100) : 0;
  const topCat = Object.entries(catSpend).sort((a, b) => b[1] - a[1])[0];
  const totalSpent = Object.values(catSpend).reduce((s, v2) => s + v2, 0);
  const alerts = [];
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4 px-4 pb-4 animate-fade-up", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between pt-4", children: [
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                background: "radial-gradient(circle at 80% 20%, #18C7B7, transparent 60%)"
              }
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground uppercase tracking-widest mb-1", children: "Available Balance" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-4xl font-bold text-foreground tracking-tight", children: fmtFull(balance) }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 flex gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 bg-muted/40 rounded-xl p-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mb-0.5", children: "Income" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-foreground text-sm", children: fmt(profile.monthlyIncome) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 bg-muted/40 rounded-xl p-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mb-0.5", children: "Fixed" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-foreground text-sm", children: fmt(profile.fixedExpenses) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 bg-muted/40 rounded-xl p-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mb-0.5", children: "Savings" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-foreground text-sm", children: fmt(profile.savingsGoal) })
            ] })
          ] })
        ]
      }
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-lg bg-primary/15 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { className: "w-4 h-4 brand-text" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-foreground text-sm", children: "Today's Limit" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                className: `text-xs px-2 py-0.5 rounded-full font-medium ${todaySpent > dailyLimit ? "bg-destructive/15 text-destructive" : "bg-primary/15 brand-text"}`,
                children: todaySpent > dailyLimit ? "Over limit" : `${fmtFull(dailyRemaining)} left`
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-end gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-3xl font-bold brand-text", children: fmtFull(dailyLimit) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm pb-1", children: "/day" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-2 bg-muted rounded-full overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                className: `h-full rounded-full transition-all duration-700 ${todaySpent > dailyLimit ? "bg-destructive" : "brand-bg"}`,
                style: {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mb-2", children: "Last 7 days" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "svg",
              {
                viewBox: "0 0 200 40",
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("defs", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("linearGradient", { id: "spark-grad", x1: "0", y1: "0", x2: "0", y2: "1", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "0%", stopColor: "#18C7B7", stopOpacity: "0.3" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "100%", stopColor: "#18C7B7", stopOpacity: "0" })
                  ] }) }),
                  (() => {
                    const pts = last7.map((v2, i) => ({
                      x: i / 6 * 198 + 1,
                      y: 38 - v2 / maxVal * 36
                    }));
                    ...
                    return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: area, fill: "url(#spark-grad)" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "path",
                        {
                          d: path,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card p-5 space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-sm mb-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-foreground", children: "Monthly Budget" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-muted-foreground", children: [
            Math.round(budgetPct),
            "%"
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Progress, { value: budgetPct, className: "h-2.5" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full h-px bg-border/40" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-sm mb-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-foreground", children: "Savings Progress" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "brand-text font-medium", children: [
            Math.round(savingsPct),
            "%"
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Progress, { value: savingsPct, className: "h-2.5" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-xs text-muted-foreground mt-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
            fmtFull(saved),
            " saved"
    ...
    alerts.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", "data-ocid": "dashboard.panel", children: alerts.map((a, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
    ...
    Object.keys(catSpend).length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground uppercase tracking-wider mb-2", children: "This Month" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: Object.entries(catSpend).sort((a, b) => b[1] - a[1]).map(([cat, amt]) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "span",
        {
...
const CATEGORY_META = {
  Food: {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(UtensilsCrossed, { className: "w-4 h-4" }),
    color: "text-orange-400",
    bg: "bg-orange-400/15"
  },
  Travel: {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Plane, { className: "w-4 h-4" }),
    color: "text-blue-400",
    bg: "bg-blue-400/15"
  },
  Shopping: {
  ...
  Other: {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleHelp, { className: "w-4 h-4" }),
...
function ExpensesScreen({ expenses, onAdd, onDelete }) {
  ...
  const [error, setError] = reactExports.useState("");
  const handleNoteChange = reactExports.useCallback((val) => {
    setNote(val);
  ...
  const totalThisMonth = expenses.filter((e) => e.date.startsWith(todayStr().slice(0, 7))).reduce((s, e) => s + e.amount, 0);
  const catTotals = {};
  for (const e of expenses.filter(
    (e2) => e2.date.startsWith(todayStr().slice(0, 7))
  )) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4 px-4 pb-4 animate-fade-up", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between pt-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-bold text-foreground", children: "Expenses" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            ...
            showForm ? "Hide" : "Add",
            showForm ? /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronUp, { className: "w-3 h-3" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { className: "w-3 h-3" })
          ]
        }
      )
    ] }),
    showForm && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card p-5 space-y-3", "data-ocid": "expenses.panel", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-foreground text-sm", children: "Add Expense" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs text-muted-foreground mb-1 block", children: "Amount (₹)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
              type: "number",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs text-muted-foreground mb-1 block", children: "Date" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
              type: "date",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs text-muted-foreground mb-1 block", children: "Note (auto-categorizes)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            type: "text",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2 flex-wrap", children: Object.keys(CATEGORY_META).map((cat) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              className: `flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-medium border transition-all ${category === cat ? `${bg} ${color} border-current` : "bg-muted/40 text-muted-foreground border-border/50 hover:border-border"}`,
    ...
    Object.keys(catTotals).length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2 flex-wrap", children: Object.entries(catTotals).sort((a, b) => b[1] - a[1]).map(([cat, amt]) => {
    ...
    Object.keys(groups).length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-12", "data-ocid": "expenses.empty_state", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-4xl mb-3", children: "💸" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground font-medium", children: "No expenses yet" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground/60 mt-1", children: "Add your first expense above" })
    ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: Object.entries(groups).map(([dateKey, items], gi) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-muted-foreground uppercase tracking-wider", children: formatDateLabel(dateKey) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: fmt(items.reduce((s, e) => s + e.amount, 0)) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: items.map((expense, i) => {
            const meta = CATEGORY_META[expense.category];
            return /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                className: `flex items-center gap-3 px-4 py-3 ${i < items.length - 1 ? "border-b border-border/30" : ""}`,
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-foreground truncate", children: expense.note }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `text-xs ${meta.color}`, children: expense.category })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-foreground flex-shrink-0", children: fmt(expense.amount) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      type: "button",
...
function GoalsScreen({
  ...
  const [goalName, setGoalName] = reactExports.useState(profile.goalName);
  const [goalAmount, setGoalAmount] = reactExports.useState(String(profile.savingsGoal));
  ...
  const pct = profile.savingsGoal > 0 ? Math.min(100, totalSaved / profile.savingsGoal * 100) : 0;
  ...
  const budget = monthlyBudget(profile);
  const savingsRate = profile.monthlyIncome > 0 ? Math.round(profile.savingsGoal / profile.monthlyIncome * 100) : 0;
  function saveEdit() {
    setErr("");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4 px-4 pb-4 animate-fade-up", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between pt-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-bold text-foreground", children: "Goals" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Track your savings journey" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
          onClick: () => setEditing((v2) => !v2),
    ...
    editing && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card p-5 space-y-3", "data-ocid": "goals.panel", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-foreground text-sm", children: "Edit Goal" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs text-muted-foreground mb-1 block", children: "Goal Name" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            value: goalName,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs text-muted-foreground mb-1 block", children: "Target (₹)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
              type: "number",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs text-muted-foreground mb-1 block", children: "Saved Already (₹)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
              type: "number",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card p-5 relative overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          className: "absolute inset-0 opacity-5",
          style: {
            background: "radial-gradient(circle at 20% 80%, #18C7B7, transparent 50%)"
          }
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-xl bg-primary/15 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Target, { className: "w-5 h-5 brand-text" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-foreground", children: profile.goalName }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
            "Target: ",
            fmtFull(profile.savingsGoal)
          ] })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 mb-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex-shrink-0", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-sm font-bold brand-text", children: [
            Math.round(pct),
            "%"
          ] }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-2xl font-bold text-foreground", children: fmtFull(totalSaved) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
            "saved of ",
            fmtFull(profile.savingsGoal)
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Progress, { value: pct, className: "mt-2 h-2" })
        ] })
      ] })
    ] }),
    ...
    ].map((stat) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card p-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mb-1", children: stat.label }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `text-lg font-bold ${stat.color}`, children: stat.value })
    ] }, stat.label)) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card p-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { className: "w-4 h-4 brand-text" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-foreground text-sm", children: "Milestones" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: milestones.map((m) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: `w-6 h-6 rounded-full flex items-center justify-center flex-shrink-0 ${pct >= m ? "brand-bg" : "bg-muted"}`,
            children: pct >= m ? /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "w-3 h-3 text-background" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-1.5 h-1.5 bg-muted-foreground rounded-full" })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-xs", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "span",
            {
              className: pct >= m ? "text-foreground font-medium" : "text-muted-foreground",
              children: [
                m,
                "% — ",
                fmtFull(profile.savingsGoal * m / 100)
              ]
            }
          ),
          pct >= m && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "brand-text", children: "✓ Achieved" })
        ] }) })
      ] }, m)) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card p-4 bg-primary/5 border border-primary/20", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mb-1", children: "💡 Savings Insight" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-foreground", children: [
        "Your savings goal is",
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "brand-text font-semibold", children: [
          savingsRate,
          "%"
        ] }),
        " of your income. Your spendable budget is",
        " ",
        ...
        ".",
        savingsRate >= 20 ? " Great savings discipline! 🎉" : " Try to increase savings to 20%+ of income."
      ] })
    ] })
  ] });
}
function ScoreGauge({ score }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", style: { width: 160, height: 95 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "svg",
        {
          viewBox: "0 0 160 95",
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("defs", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("filter", { id: "score-glow", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-0 left-1/2 -translate-x-1/2 -translate-y-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-semibold", style: { color }, children: [
        emoji,
        " ",
        label
      ] }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1", children: "out of 100" })
  ] });
}
const TIPS_BY_SCORE = {
  high: [
...
function ScoreScreen({ profile, expenses }) {
  const scoreData = reactExports.useMemo(
    () => healthScore(profile, expenses),
    [profile, expenses]
  );
  const { score, savingsRate, budgetDiscipline, consistency } = scoreData;
  const tips = score >= 70 ? TIPS_BY_SCORE.high : score >= 40 ? TIPS_BY_SCORE.mid : TIPS_BY_SCORE.low;
  const budget = monthlyBudget(profile);
  const spent = monthlySpent(expenses);
  ...
  function barColor(v2) {
    if (v2 >= 70) return "brand-bg";
    if (v2 >= 40) return "bg-warning";
    return "bg-destructive";
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4 px-4 pb-4 animate-fade-up", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-bold text-foreground", children: "Financial Health" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Your money management score" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 text-center", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground mt-1", children: [
              "Spendable: ",
              fmt(budget - spent > 0 ? budget - spent : 0),
              " remaining"
            ] })
          ] })
        ]
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card p-5 space-y-4", "data-ocid": "score.panel", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-foreground text-sm", children: "Score Breakdown" }),
      BREAKDOWN_ITEMS.map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": `score.item.${i + 1}`, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "brand-text", children: item.icon }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card p-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Lightbulb, { className: "w-4 h-4 brand-text" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-foreground text-sm", children: "Personalized Tips" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2.5", children: tips.map((tip, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: "flex items-start gap-2 text-sm text-foreground/90 leading-relaxed",
          "data-ocid": `score.item.${i + 4}`,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mt-0.5 flex-shrink-0 text-base leading-none", children: tip.slice(0, 2) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: tip.slice(2) })
          ]
        },
        tip
      )) })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card p-4 bg-primary/5 border border-primary/20", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mb-1.5", children: "ℹ️ How it's calculated" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-foreground/80 leading-relaxed", children: [
        "Your score combines ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "savings rate" }),
        " (40%),",
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "budget discipline" }),
        " (35%), and",
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "spending consistency" }),
        " (25%). Add more expenses over time for a more accurate score."
      ] })
    ] })
  ] });
}
function App() {
  ...
  const [screen, setScreen] = reactExports.useState("dashboard");
  reactExports.useEffect(() => {
  ...
  function handleChatUpdate(msgs) {
  ...
  if (!profile) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("meta", { name: "theme-color", content: "#0B0E10" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Onboarding, { onComplete: handleOnboardingComplete }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Toaster, { richColors: true, position: "top-center" })
    ] });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center items-start min-h-screen bg-black", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "main",
          {
            ...
            children: [
              screen === "dashboard" && /* @__PURE__ */ jsxRuntimeExports.jsx(
                Dashboard,
                {
                  profile,
                  expenses,
              ...
              screen === "expenses" && /* @__PURE__ */ jsxRuntimeExports.jsx(
                ExpensesScreen,
                {
                  expenses,
              ...
              screen === "goals" && /* @__PURE__ */ jsxRuntimeExports.jsx(
                GoalsScreen,
                {
                  profile,
                  expenses,
              ...
              screen === "chat" && /* @__PURE__ */ jsxRuntimeExports.jsx(
                ChatScreen,
                {
              ...
              screen === "score" && /* @__PURE__ */ jsxRuntimeExports.jsx(ScoreScreen, { profile, expenses })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(BottomNav, { active: screen, onChange: setScreen }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Toaster, { richColors: true, position: "top-center" })
      ]
    }
  ) });
...
const Role = Variant({ "agent": Null, "user": Null });
...
Service({
  "addInventoryItem": Func([Text, Nat], [Bool], []),
  "addMessage": Func([SessionId, Role, Text], [Bool], []),
  "addUserMessageWithResponse": Func(
    [SessionId, Text],
    [Text],
    []
  ),
  "checkInventory": Func([Text], [Opt(Nat)], ["query"]),
  "clearSession": Func([SessionId], [Bool], []),
  "createSession": Func([], [SessionId], []),
  "getAllInventory": Func(
    [],
    [Vec(Tuple(Text, Nat))],
    ["query"]
  ),
  "getSessionMessages": Func([SessionId], [Vec(Message)], ["query"])
});
