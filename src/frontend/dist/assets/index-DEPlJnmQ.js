...
const PackageCheck = createLucideIcon("package-check", __iconNode$7);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const PackageX = createLucideIcon("package-x", __iconNode$6);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const MAIN_TABS = [
  { id: "shopify", label: "Shopify", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(ShoppingBag, { size: 18 }) },
  { id: "eshopbox", label: "Eshopbox", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Box, { size: 18 }) },
  {
    id: "under-production",
    label: "Order Under Production",
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Factory, { size: 18 })
  },
  {
    id: "orders-request",
...
const SHOPIFY_SUB_TABS = [
  {
    ...
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(PackageCheck, { size: 16 })
  },
  {
...
const ESHOPBOX_SUB_TABS = [
  ...
  },
  {
    ...
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowLeftRight, { size: 16 })
  },
  {
    id: "return-cod",
    label: "Return-COD",
...
const ORDERS_REQUEST_SUB_TABS = [
  ...
  },
  {
    id: "unfulfilled",
    label: "Unfulfilled",
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(PackageX, { size: 16 })
  },
  {
    id: "cancelled",
    label: "Cancelled",
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Ban, { size: 16 })
  },
  {
    id: "urgent-delivery",
...
${SIGN_OFF}`
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    TabLayout,
    {
      fields: /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          FormField,
          {
            label: "Customer Name",
...
function DamagedUnitTab() {
  const [fields, setFields] = reactExports.useState({ name: "", orderId: "", itemName: "" });
  const [message, setMessage] = reactExports.useState("");
  const [copied, setCopied] = reactExports.useState(false);
  const set = (k) => (v) => setFields((p) => ({ ...p, [k]: v }));
  const generate = () => {
...
function ReturnCODTab() {
  ...
  const generate = () => {
    ...
    const itemLines = itemsToPickup.split("\n").map((l) => l.trim()).filter((l) => l.length > 0);
    const noteSection = itemLines.length > 0 ? `
...
function AbandonedCheckoutTab() {
  ...
  const set = (k) => (v) => setFields((p) => ({ ...p, [k]: v }));
  const generate = () => {
    const { name, itemName, discountPercent, promoCode, productCategory } = fields;
    setMessage(
      `Hi ${name || "[Name]"},
...
function TabLayout({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-lg shadow-card flex flex-col", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-5 py-4 border-b border-border", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-base font-semibold text-foreground", children: "1. Input Customer Details" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: "Fill in the fields below to generate the message." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-5 py-4 flex flex-col gap-4 flex-1", children: fields }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-lg shadow-card flex flex-col", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-5 py-4 border-b border-border", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-base font-semibold text-foreground", children: "2. Message Preview" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: "Your generated message will appear here." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-5 py-4 flex-1", "data-ocid": "preview.panel", children: message ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-preview-bubble rounded-lg p-4 text-sm leading-relaxed text-foreground whitespace-pre-wrap", children: message }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: "flex flex-col items-center justify-center h-40 text-center gap-3",
          "data-ocid": "preview.empty_state",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(MessageSquare, { size: 32, className: "text-muted-foreground/40" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Fill in the form and click “Generate Message” to preview the message here." })
          ]
        }
      ) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-5 pb-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button,
        {
          ...
          children: copied ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(ClipboardCheck, { size: 15, className: "mr-2" }),
            " Copied!"
          ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Clipboard, { size: 15, className: "mr-2" }),
            " Copy to Clipboard"
          ] })
        }
      ) })
...
function ShopifySection() {
  const [activeSubTab, setActiveSubTab] = reactExports.useState("order-confirm");
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-muted/40 border border-border rounded-lg mb-5 overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-w-max", children: SHOPIFY_SUB_TABS.map((sub) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          className: [
            ...
            isActive ? "text-primary border-b-2 border-primary bg-background" : "text-muted-foreground hover:text-foreground hover:bg-muted/50 border-b-2 border-transparent"
          ].join(" "),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: activeSubTab === "order-confirm" ? /* @__PURE__ */ jsxRuntimeExports.jsx(OrderConfirmTab, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(AbandonedCheckoutTab, {}) }, activeSubTab)
  ] });
}
function EshopboxSection() {
  const [activeSubTab, setActiveSubTab] = reactExports.useState("delivery-failed");
  const renderSubTab = () => {
    switch (activeSubTab) {
      case "delivery-failed":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(DeliveryFailedTab, {});
      case "damaged-unit":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(DamagedUnitTab, {});
      case "wrong-unit":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(WrongUnitTab, {});
      case "return-cod":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(ReturnCODTab, {});
      case "return-prepaid":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(ReturnPrepaidTab, {});
    }
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-muted/40 border border-border rounded-lg mb-5 overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-w-max", children: ESHOPBOX_SUB_TABS.map((sub) => {
      const isActive = sub.id === activeSubTab;
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: renderSubTab() }, activeSubTab)
  ] });
}
function OrdersRequestSection() {
  const [activeSubTab, setActiveSubTab] = reactExports.useState("order-cancellation");
  const renderSubTab = () => {
    switch (activeSubTab) {
      case "order-cancellation":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(OrderCancellationTab, {});
      case "estimate-delivery":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(EstimateDeliveryTab, {});
      case "unfulfilled":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(UnfulfilledTab, {});
      case "cancelled":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(CancelledTab, {});
      case "urgent-delivery":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(UrgentDeliveryTab, {});
    }
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-muted/40 border border-border rounded-lg mb-5 overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-w-max", children: ORDERS_REQUEST_SUB_TABS.map((sub) => {
      const isActive = sub.id === activeSubTab;
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
...
const MAIN_TAB_COMPONENTS = {
  shopify: /* @__PURE__ */ jsxRuntimeExports.jsx(ShopifySection, {}),
  eshopbox: /* @__PURE__ */ jsxRuntimeExports.jsx(EshopboxSection, {}),
  "under-production": /* @__PURE__ */ jsxRuntimeExports.jsx(UnderProductionTab, {}),
  "orders-request": /* @__PURE__ */ jsxRuntimeExports.jsx(OrdersRequestSection, {})
};
function App() {
  const [activeTab, setActiveTab] = reactExports.useState("shopify");
  const activeTabInfo = MAIN_TABS.find((t) => t.id === activeTab);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col bg-background font-sans", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "header",
      {
        className: "bg-card border-b border-border shadow-xs sticky top-0 z-50",
        "data-ocid": "header.section",
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 h-14 flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center w-8 h-8 rounded-lg bg-primary text-primary-foreground text-xs font-bold tracking-tight select-none", children: "CS" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-foreground text-sm tracking-tight", children: "CS Message Pro" })
        ] })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex-1 max-w-7xl mx-auto w-full px-4 sm:px-6 py-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-lg font-semibold text-foreground", children: activeTabInfo.label }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: "Customer Support Message Generator" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-card border border-border rounded-lg shadow-xs mb-6 overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-w-max", children: MAIN_TABS.map((tab) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            className: [
              ...
              isActive ? "text-primary border-b-2 border-primary bg-accent/50" : "text-muted-foreground hover:text-foreground hover:bg-muted/50 border-b-2 border-transparent"
            ].join(" "),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: MAIN_TAB_COMPONENTS[activeTab] }, activeTab)
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "py-4 text-center text-xs text-muted-foreground border-t border-border", children: [
      "\\u00a9 ",
