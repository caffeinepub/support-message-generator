...
const ClipboardCheck = createLucideIcon("clipboard-check", __iconNode$a);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const Factory = createLucideIcon("factory", __iconNode$7);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const FileX = createLucideIcon("file-x", __iconNode$6);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const TABS = [
  ...
  },
  {
    ...
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(RefreshCw, { size: 18 })
  },
  {
  ...
  },
  {
    ...
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(FileX, { size: 18 })
  }
];
...
function TypeToggle({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 mb-2", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        type: "button",
        onClick: () => onChange("cod"),
        className: `flex-1 py-2 rounded-lg text-xs font-semibold border transition-colors ${value === "cod" ? "bg-primary text-primary-foreground border-primary" : "bg-card text-muted-foreground border-border hover:bg-muted/50"}`,
        "data-ocid": `${prefix2}-cod.toggle`,
        children: "COD"
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        className: `flex-1 py-2 rounded-lg text-xs font-semibold border transition-colors ${value === "prepaid" ? "bg-primary text-primary-foreground border-primary" : "bg-card text-muted-foreground border-border hover:bg-muted/50"}`,
        "data-ocid": `${prefix2}-prepaid.toggle`,
        children: "Prepaid"
      }
    )
  ] });
...
function CancelRequestTab() {
  const [cancelType, setCancelType] = reactExports.useState("cod");
  const [codFields, setCodFields] = reactExports.useState({
    name: "",
    orderId: "",
    itemName: ""
  });
  const [prepaidFields, setPrepaidFields] = reactExports.useState({
    name: "",
    orderId: "",
    itemName: "",
    refundAmount: ""
  ...
  const [message, setMessage] = reactExports.useState("");
  const [copied, setCopied] = reactExports.useState(false);
  const setCod = (k) => (v) => setCodFields((p) => ({ ...p, [k]: v }));
  const setPrepaid = (k) => (v) => setPrepaidFields((p) => ({ ...p, [k]: v }));
  const generate = () => {
    if (cancelType === "cod") {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    TabLayout,
    {
      fields: /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        ...
        cancelType === "cod" ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            FormField,
            {
              label: "Customer Name",
...
const TAB_COMPONENTS = {
  "order-confirm": /* @__PURE__ */ jsxRuntimeExports.jsx(OrderConfirmTab, {}),
  "delivery-failed": /* @__PURE__ */ jsxRuntimeExports.jsx(DeliveryFailedTab, {}),
  "damaged-unit": /* @__PURE__ */ jsxRuntimeExports.jsx(DamagedUnitTab, {}),
  "wrong-unit": /* @__PURE__ */ jsxRuntimeExports.jsx(WrongUnitTab, {}),
  "under-production": /* @__PURE__ */ jsxRuntimeExports.jsx(UnderProductionTab, {}),
  "return-cod": /* @__PURE__ */ jsxRuntimeExports.jsx(ReturnCODTab, {}),
  "return-prepaid": /* @__PURE__ */ jsxRuntimeExports.jsx(ReturnPrepaidTab, {}),
  "abandoned-checkout": /* @__PURE__ */ jsxRuntimeExports.jsx(AbandonedCheckoutTab, {}),
  "cancel-request": /* @__PURE__ */ jsxRuntimeExports.jsx(CancelRequestTab, {})
};
function App() {
  const [activeTab, setActiveTab] = reactExports.useState("order-confirm");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col bg-background font-sans", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex-1 max-w-7xl mx-auto w-full px-4 sm:px-6 py-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-card border border-border rounded-lg shadow-xs mb-6 overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-w-max", children: TABS.map((tab) => {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: TAB_COMPONENTS[activeTab] }, activeTab)
    ] }),
